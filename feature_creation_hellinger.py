...
for exploit in tqdm(exploits):
    ...
    # with open('./data/raid/{}_hell_full.csv'.format(exploit), 'w') as f:
    with open('./data/raid/{}_hell_unnorm.csv'.format(exploit), 'w') as f:
    # with open('./data/raid/{}_hell_nf.csv'.format(exploit), 'w') as f:
        writer = csv.writer(f)
